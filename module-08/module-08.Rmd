...
Thus, if the population variance $\sigma^2$ (and thus the population standard deviation $\sigma$) is known, then the standard error can be calculated as **$\sigma$ / (square root of the sample size)**, or...
