---
title: "Module 2 - Basics of Version Control with ***`git`***, ***`GitHub`***, and ***`GitHub Desktop`***"
output:
    #github_document:
    html_document:
      theme: cerulean
...
# Objectives
>To introduce the basics of working with version control systems, but outside of and within ***`R`***.
...
<center><img src="install-git.jpg" width=500px/></center>
...
<center><img src="atom.jpg" width=500px/></center>

## Get Started with ***`GitHub`*** and Creating Repositories
...
<center><img src="github.jpg" width=500px/></center>
...
<center><img src="hello-world.jpg" width=500px/></center>

- In doing so, you should:

	- Create a **repository** (colloquially, a **repo**) and name it (e.g., "exercise-1"). **NOTE:** Do not include spaces in your repo name!
...
<center><img src="github-desktop.jpg" width=500px/></center>
...
<center><img src="clone-repo.jpg" width=500px/></center>

<center><img src="clone-from-github.jpg" width=500px/></center>
...
- Open ***`GitHub Desktop`*** and create a new local repo (e.g., "exercise=2")

<center><img src="create-local-repo.jpg" width=500px/></center>
...
<center><img src="empty-repo.jpg" width=500px/></center>
...
<center><img src="first-commit.jpg" width=500px/></center>

- After you have committed the file, you can choose *Publish* to push your repo to **GitHub**.

<center><img src="publish-to-github.jpg" width=500px/></center>
