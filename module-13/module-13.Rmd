...
In many cases, the continuous metric data we have are not normally distributed, but we can often apply some kind of mathematical transformation to those data to change their distribution to more closely approximate the normal. 
