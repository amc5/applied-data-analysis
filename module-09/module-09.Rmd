...
Note that $\mu_0$ here is the expected difference between the means under the null hypothesis, which is zero.
...
Again, note that $\mu_0$ here is the expected difference between the means under the null hypothesis, which is zero, and we are dividing by the standard error of the mean for the set of differences between pairs.
...
where:
  ...
  * $\mu_0$ = expected mean difference between groups (usually set to zero)
  * $s_1$ and $s_2$ = sample standard deviations
  * $n_1$ and $n_2$ = numbers of sample observations
...
where:
  ...
  * $\mu_0$ = expected mean between paired difference (usually set to zero)
  * $s_d$ = standard deviation in differences between paired samples
