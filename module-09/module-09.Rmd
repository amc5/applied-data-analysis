...
### One Sample Z and T Tests for Sample Means
...
### Two Sample Tests Z and T Tests for Comparing Means
...
When dealing with sample means, the Z statistic is calculated as:
...
where:
  ...
  * $\mu$ = expected mean difference between sample groups (usually set to zero)
...
### One Sample Z Tests for Proportions
